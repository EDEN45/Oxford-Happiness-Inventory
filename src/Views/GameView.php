...
<head>
  ...
  <script src="static/game/localforage.js"></script>
	...
	<link rel="apple-touch-icon" sizes="256x256" href="static/game/icon-256.png" />
	<meta name="HandheldFriendly" content="true" />

	<!-- Chrome for Android web app tags -->
	<meta name="mobile-web-app-capable" content="yes" />
	<link rel="shortcut icon" sizes="256x256" href="static/game/icon-256.png" />
...
<body>
  ...
  <div id="c2canvasdiv">
	...
	<script src="static/game/jquery-2.1.1.min.js"></script>



    <!-- The runtime script.  You can rename it, but don't forget to rename the reference here as well.
    This file will have been minified and obfuscated if you enabled "Minify script" during export. -->
	<script src="static/game/c2runtime.js"></script>
